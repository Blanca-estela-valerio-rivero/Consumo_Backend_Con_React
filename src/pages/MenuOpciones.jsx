...
import { currentUser } from "../shared/constants/data";
import {
  obtenerAlumnos,
  crearAlumno,
  actualizarAlumno,
  eliminarAlumno,
} from "../features/alumnos/services/alumnoService";
import {
  obtenerMaterias,
  crearMateria,
  actualizarMateria,
  eliminarMateria,
} from "../features/materias/services/materiaService";
import {
  obtenerSemestres,
  crearSemestre,
  actualizarSemestre,
  eliminarSemestre,
} from "../features/semestres/services/semestreService";
import Sidebar from "../layouts/Sidebar.jsx";
import SemestreCard from "../features/semestres/components/SemestreCard.jsx";

const navigationItems = {
  principal: [{ id: "dashboard", label: "Dashboard", icon: "bi-speedometer2" }],
  gestion: [
...
export default function MenuOpciones({ activeItem = "semestres", onNavigate }) {
  ...
  const renderSectionContent = () => {
    if (activeItem === "dashboard") {
      ...
      const distributionCounts = carreras.map(
        (c) => alumnos.filter((a) => a.carrera === c).length,
      );
    ...
    if (activeItem === "alumnos") {
      ...
      const getAvatarColorByCarrera = (carrera) => {
        const map = {
          "Ingeniería En Sistemas Computacionales": "avatar-blue",
          "Ingeniería Civil": "avatar-purple",
          "Ingeniería Industrial": "avatar-cyan",
          "Ingeniería Mecatrónica": "avatar-orange",
          "Ingeniería En Gestión Empresarial": "avatar-green",
          "Licenciatura En Administración": "avatar-blue",
          "Licenciatura Arquitectura": "avatar-blue",
          "Licenciatura En Contador Público": "avatar-purple",
        };
            ...
            {filteredAlumnos.map((alumno) => {
              return (
                ...
                >
                  ...
                  <div className="materia-col-profesor" style={{ flex: "2" }}>
                    {alumno.imagenURL ? (
                      <img
                        ...
                        alt={alumno.nombre}
                        className="avatar-circle avatar-xs"
                        style={{ objectFit: "cover" }}
                      />
                    ) : (
                      <div
                        className={`avatar-circle avatar-xs ${getAvatarColorByCarrera(alumno.carrera)}`}
                      >
                  ...
                  <div
                    className="materia-col-creditos"
                    style={{ width: "100px" }}
                  >
                  ...
                  <div className="d-flex gap-2 ms-auto align-items-center">
                    ...
                    <button
                      ...
                      style={{ border: "none" }}
                      onClick={() =>
                        handleDelete(alumno.id_alumno || alumno.id)
                      }
                    >
                ...
                >
                  ...
                  >
                    ...
                    <button
                      ...
                      style={{
                        filter:
                          "brightness(0) saturate(100%) invert(71%) sepia(96%) saturate(1745%) hue-rotate(156deg) brightness(95%) contrast(101%)",
                      }}
                      onClick={() => {
                        setShowModal(false);
                        setAlumnoEditando(null);
                        ...
                        <div className="col-md-6">
                          ...
                          <select
                            ...
                            style={{
                              ...inputStyle,
                              backgroundImage:
                                "url(\"data:image/svg+xml;charset=UTF-8,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16'%3e%3cpath fill='none' stroke='%2322d3ee' stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='m2 5 6 6 6-6'/%3e%3c/svg%3e\")",
        ...
        <div className="px-5 pb-5 pt-4 flex-grow-1">
          <div className="d-flex justify-content-between align-items-start mb-4">
            <div>
              ...
              <p style={{ color: "#94a3b8", fontSize: "0.9rem" }}>
                Gestión de materias y contenido curricular
              </p>
            </div>
            <button
              className="btn fw-semibold mt-2"
                  ...
                  <div key={materia.id} className="materia-row-compact">
                    ...
                    <div className="d-flex gap-2 ms-3 align-items-center">
                      ...
                      <button
                        ...
                        style={{ border: "none" }}
                        onClick={() =>
                          handleDeleteMateria(materia.id || materia.id_materia)
                        }
                      >
                        <i className="bi bi-trash"></i>
                      </button>
                      ...
                      <div className="row g-3">
                        ...
                        <div className="col-md-6">
                          ...
                          >
                            ...
                            {semestres.map((sem) => (
                              <option
                                key={sem.id || sem.id_semestre}
                                value={sem.id || sem.id_semestre}
                                style={{
                                  backgroundColor: "#101720",
                                  color: "#e2e8f0",
                                }}
  ...
  return (
    <div className="d-flex" style={{ height: "100vh", background: "#0b111a" }}>
      <Sidebar
        navigationItems={dynamicNavigationItems}
      ...
      <main
        ...
        style={{ overflowY: "auto", background: "#0b111a" }}
      >
          ...
          <div className="px-5 pb-5 pt-4 flex-grow-1">
            <div className="d-flex justify-content-between align-items-start mb-5">
              <div>
                ...
                <p style={{ color: "#94a3b8", fontSize: "0.9rem" }}>
                  Gestión de ciclos y semestres escolares
                </p>
              </div>
              <button
                className="btn fw-semibold mt-2"
            ...
            <div className="materia-list-compact">
              {semestres.map((semestre) => (
                <SemestreCard
                  ...
                  onDelete={async () => {
                    if (
                      window.confirm("¿Estás seguro de eliminar este semestre?")
                    ) {
                      try {
                        await eliminarSemestre(
                          semestre.id || semestre.id_semestre,
                        );
            ...
            {showModalSemestre && (
              ...
              >
                <div
                  className="modal-semestre-content"
                ...
                >
                  ...
                  <div className="modal-semestre-body">
                    <div className="form-group-semestre">
                      <label className="label-semestre-input">
                        NUEVO SEMESTRE *
                      </label>
                      <input
                        type="text"
